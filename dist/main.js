...
eval("function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Compare = function Compare(el) {\n  var _this = this;\n\n  _classCallCheck(this, Compare);\n\n  var is_active = false;\n  this.$el = document.querySelector(el);\n  this.control = this.$el.querySelector('#slider__control');\n  this.afterImage = this.$el.querySelector('#slider__after');\n  this.$el.addEventListener('mousemove', function (event) {\n    if (event.target.className === 'slider__image') {\n      var x = event.offsetX;\n      event.preventDefault();\n\n      _this.control.addEventListener('mousedown', function () {\n        event.preventDefault();\n        is_active = true;\n      });\n\n      _this.$el.addEventListener('mouseup', function () {\n        is_active = false;\n      });\n\n      if (is_active === true) {\n        _this.afterImage.style.width = x + 'px';\n        _this.control.style.left = _this.afterImage.style.width;\n      }\n    }\n  });\n};\n\nvar compare = new Compare('#slider__item');\nvar compare2 = new Compare('#slider__item__2');\nvar compare3 = new Compare('#slider__item__3');\n\n//# sourceURL=webpack:///./src/modules/slider/compare.js?");
